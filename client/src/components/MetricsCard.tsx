    ...
    return (
      <div className="craft-card-lift" style={cardStyle}>
        ...
        <p style={{ color: "#9ca3af", fontSize: 13 }}>
          Run a few tasks to populate metrics.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="craft-card-lift" style={cardStyle}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <span
            ...
            style={{ color: "#9d3e1a", fontSize: 20 }}
          >
            monitoring
          </span>
      ...
      >
        ...
        <Stat
          label="First Attempt"
          value={`${metrics.firstAttemptSuccessRate}%`}
        />

        <Stat
          label="Within 3 Attempts"
          value={`${metrics.withinThreeAttemptsRate}%`}
        />
      ...
      {cats.length > 0 && (
        <div>
          ...
          {cats.map(([cat, count]) => {
            const pct = metrics.totalRuns
              ? Math.round((count / metrics.totalRuns) * 100)
              : 0;
